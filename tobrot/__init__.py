...
if os.path.exists("priiiiyo-leech-bot.txt"):
    with open("priiiiyo-leech-bot.txt", "r+") as f_d:
        f_d.truncate(0)
...
logging.basicConfig(
    ...
    handlers=[
        RotatingFileHandler(
            "priiiiyo-leech-bot.txt", maxBytes=50000000, backupCount=10
        ),
...
PURGEME_COMMAND = os.environ.get("PURGEME_COMMAND", "purgeme")
