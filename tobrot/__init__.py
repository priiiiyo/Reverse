...
EDIT_SLEEP_TIME_OUT = os.environ.get("EDIT_SLEEP_TIME_OUT", "15"))
MAX_TIME_TO_WAIT_FOR_TORRENTS_TO_START = int(
    os.environ.get("MAX_TIME_TO_WAIT_FOR_TORRENTS_TO_START", 600)
)
MAX_TG_SPLIT_FILE_SIZE = os.environ.get("MAX_TG_SPLIT_FILE_SIZE", "1072864000"))
...
TOGGLE_DOC_COMMAND = os.environ.get("TOGGLE_DOC_COMMAND", "toggledoc")+BOT
TOGGLE_VIDEO_COMMAND = os.environ.get("TOGGLE_VIDEO_COMMAND", "togglevideo")+BOT
